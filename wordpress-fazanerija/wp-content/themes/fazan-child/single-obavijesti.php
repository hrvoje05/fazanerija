      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            <h1 class="mb-3 bread">Obavijest</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="<?php bloginfo('url'); ?>"> Naslovna</a></span><i class="fas fa-chevron-right" style="margin-right: 6px;"></i><span class="mr-2"><a href="<?php bloginfo('url'); ?>/arhiva-obavijesti"> Obavijesti</a></span><i class="fas fa-chevron-right" style="margin-right: 6px;"></i><span class="mr-2"><a href="<?php the_permalink(); ?>"><?php the_title();?></a></span></p>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          ...
          <div class="<?php echo (has_post_thumbnail() ? 'col-lg-6' : 'col-lg-12'); ?> order-lg-last ftco-animate">
            ...
            <p class="datoteka-obavijesti text-center font-weight-bold">
                            <?php
                            $file = get_field('prilozene_datoteke_obavijesti');
                            if( $file ):
